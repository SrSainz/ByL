...
`OPENAI_API_KEY` es opcional. Si existe, la lectura de facturas usa IA para extraer datos estructurados. Si no existe, la app guarda el PDF y usa reglas simples sobre texto/nombre de archivo.
