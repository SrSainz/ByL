  ...
  return (
    <div>
      <div className="mb-6 text-center">
        ...
        <p className="mt-1 text-sm text-muted">Usa el acceso que te ha facilitado administración.</p>
      </div>
      <div className="mb-5 grid gap-2 text-sm sm:grid-cols-2">
        <div className="rounded-md bg-surface-subtle px-3 py-2">
          ...
          <p className="text-xs text-muted">Crear y revisar tus incidencias.</p>
        </div>
        <div className="rounded-md bg-surface-subtle px-3 py-2">
          <p className="font-semibold text-slate-950">Admin</p>
          <p className="text-xs text-muted">Gestionar incidencias y facturas.</p>
        </div>
      </div>
      <LoginForm />
    </div>
