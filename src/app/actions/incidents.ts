...
export async function createIncidentAction(
  ...
  const payload = {
    ...
    categoria: canUseAdminFields ? nullableString(formData, "categoria") : null,
    numero_factura: canUseAdminFields ? nullableString(formData, "numero_factura") : null,
    fecha_factura: canUseAdminFields ? nullableString(formData, "fecha_factura") : null,
    importe_neto: canUseAdminFields ? nullableNumber(formData, "importe_neto") : null,
    iva_factura: canUseAdminFields ? nullableNumber(formData, "iva_factura") : null,
    importe_factura: canUseAdminFields ? nullableNumber(formData, "importe_factura") : null,
    observaciones: canUseAdminFields ? nullableString(formData, "observaciones") : null,
...
export async function updateIncidentAction(
  ...
  const candidate = {
    ...
    categoria: nullableString(formData, "categoria"),
    numero_factura: nullableString(formData, "numero_factura"),
    fecha_factura: nullableString(formData, "fecha_factura"),
    importe_neto: nullableNumber(formData, "importe_neto"),
    iva_factura: nullableNumber(formData, "iva_factura"),
